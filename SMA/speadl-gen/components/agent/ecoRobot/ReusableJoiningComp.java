...
public abstract class ReusableJoiningComp {
  public interface Requires {
     ...
     * 
     */
    public IInteraction universalEnvInteraction();
    
    /**
     * This can be called by the implementation to access this required port.
     * 
     */
    public IPerception universalEnvPerception();
  }
  ...
  public static abstract class JoiningEntity {
    public interface Requires {
    }
    ...
    public interface Provides {
       ...
       * 
       */
      public IInteraction joinEnvInteraction();
      
      /**
       * This can be called to access the provided port.
       * 
       */
      public IPerception joinEnvPerception();
    }
    ...
    public static class ComponentImpl implements ReusableJoiningComp.JoiningEntity.Component, ReusableJoiningComp.JoiningEntity.Parts {
      ...
      private void init_joinEnvInteraction() {
        assert this.joinEnvInteraction == null: "This is a bug.";
        this.joinEnvInteraction = this.implementation.make_joinEnvInteraction();
        if (this.joinEnvInteraction == null) {
        	throw new RuntimeException("make_joinEnvInteraction() in components.agent.ecoRobot.ReusableJoiningComp$JoiningEntity should not return null.");
        }
      }
      
      private void init_joinEnvPerception() {
        assert this.joinEnvPerception == null: "This is a bug.";
        this.joinEnvPerception = this.implementation.make_joinEnvPerception();
        if (this.joinEnvPerception == null) {
        	throw new RuntimeException("make_joinEnvPerception() in components.agent.ecoRobot.ReusableJoiningComp$JoiningEntity should not return null.");
        }
      }
      
      protected void initProvidedPorts() {
        init_joinEnvInteraction();
        init_joinEnvPerception();
      }
      ...
      private IInteraction joinEnvInteraction;
      
      public IInteraction joinEnvInteraction() {
        return this.joinEnvInteraction;
      }
      
      private IPerception joinEnvPerception;
      
      public IPerception joinEnvPerception() {
        return this.joinEnvPerception;
      }
    }
     ...
     * 
     */
    protected abstract IInteraction make_joinEnvInteraction();
     ...
     * 
     */
    protected abstract IPerception make_joinEnvPerception();
    ...
    public synchronized ReusableJoiningComp.JoiningEntity.Component _newComponent(final ReusableJoiningComp.JoiningEntity.Requires b, final boolean start) {
      ...
      this.init = true;
      ReusableJoiningComp.JoiningEntity.ComponentImpl  _comp = new ReusableJoiningComp.JoiningEntity.ComponentImpl(this, b, true);
      if (start) {
      	_comp.start();
      }
      return _comp;
  ...
  public synchronized ReusableJoiningComp.Component _newComponent(final ReusableJoiningComp.Requires b, final boolean start) {
    ...
    this.init = true;
    ReusableJoiningComp.ComponentImpl  _comp = new ReusableJoiningComp.ComponentImpl(this, b, true);
    if (start) {
    	_comp.start();
    }
    return _comp;
  ...
  public ReusableJoiningComp.JoiningEntity _createImplementationOfJoiningEntity() {
    ...
    if (implem == null) {
    	throw new RuntimeException("make_JoiningEntity() in components.agent.ecoRobot.ReusableJoiningComp should not return null.");
    }
  ...
  protected ReusableJoiningComp.JoiningEntity.Component newJoiningEntity() {
    ReusableJoiningComp.JoiningEntity _implem = _createImplementationOfJoiningEntity();
    return _implem._newComponent(new ReusableJoiningComp.JoiningEntity.Requires() {},true);
  }
}
