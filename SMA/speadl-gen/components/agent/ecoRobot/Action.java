...
public abstract class Action {
  ...
  public static class ComponentImpl implements Action.Component, Action.Parts {
    ...
    private void init_actionBuffer() {
      assert this.actionBuffer == null: "This is a bug.";
      this.actionBuffer = this.implementation.make_actionBuffer();
      if (this.actionBuffer == null) {
      	throw new RuntimeException("make_actionBuffer() in components.agent.ecoRobot.Action should not return null.");
      }
    }
    ...
    private IActionBuffer actionBuffer;
   ...
   * 
   */
  protected abstract IActionBuffer make_actionBuffer();
