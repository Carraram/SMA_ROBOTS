package components.agent.ecoRobotLogged;
...
public abstract class EcoRobotLogged {
  ...
  public static class ComponentImpl implements EcoRobotLogged.Component, EcoRobotLogged.Parts {
    ...
    private void init_l() {
      ...
      if (this.implem_l == null) {
      	throw new RuntimeException("make_l() in components.agent.ecoRobotLogged.EcoRobotLogged should not return null.");
      }
    ...
    private void init_b() {
      ...
      if (this.implem_b == null) {
      	throw new RuntimeException("make_b() in components.agent.ecoRobotLogged.EcoRobotLogged should not return null.");
      }
    ...
    private void init_elog() {
      ...
      if (this.elog == null) {
      	throw new RuntimeException("make_elog() in components.agent.ecoRobotLogged.EcoRobotLogged should not return null.");
      }
    }
   ...
   * 
   */
  protected EcoRobotLogged.RobotLogged make_RobotLogged(final String name, final float maxEnergie, final Colors couleur, final Position positionInitiale) {
   ...
   * 
   */
  public EcoRobotLogged.RobotLogged _createImplementationOfRobotLogged(final String name, final float maxEnergie, final Colors couleur, final Position positionInitiale) {
    EcoRobotLogged.RobotLogged implem = make_RobotLogged(name,maxEnergie,couleur,positionInitiale);
    if (implem == null) {
    	throw new RuntimeException("make_RobotLogged() in components.agent.ecoRobotLogged.EcoRobotLogged should not return null.");
    }
