...
public abstract class Logging {
  ...
  public static class ComponentImpl implements Logging.Component, Logging.Parts {
    ...
    private void init_create() {
      ...
      if (this.create == null) {
      	throw new RuntimeException("make_create() in components.agent.logging.Logging should not return null.");
      }
    }
  ...
  public static abstract class Logger {
    ...
    public static class ComponentImpl implements Logging.Logger.Component, Logging.Logger.Parts {
      ...
      private void init_log() {
        ...
        if (this.log == null) {
        	throw new RuntimeException("make_log() in components.agent.logging.Logging$Logger should not return null.");
        }
      }
   ...
   * 
   */
  protected abstract ICreateLogger make_create();
   ...
   * 
   */
  protected abstract Logging.Logger make_Logger(final String name);
  
  /**
   * Do not call, used by generated code.
   * 
   */
  public Logging.Logger _createImplementationOfLogger(final String name) {
    Logging.Logger implem = make_Logger(name);
    if (implem == null) {
    	throw new RuntimeException("make_Logger() in components.agent.logging.Logging should not return null.");
    }
   ...
   * 
   */
  protected Logging.Logger.Component newLogger(final String name) {
    Logging.Logger _implem = _createImplementationOfLogger(name);
