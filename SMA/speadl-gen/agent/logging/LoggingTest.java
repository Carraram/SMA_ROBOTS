...
public abstract class LoggingTest {
  ...
  public static class ComponentImpl implements LoggingTest.Component, LoggingTest.Parts {
    ...
    private void init_log() {
      ...
      if (this.implem_log == null) {
      	throw new RuntimeException("make_log() in agent.logging.LoggingTest should not return null.");
      }
  ...
  public LoggingTest.LoggerTest _createImplementationOfLoggerTest(final String name) {
    ...
    if (implem == null) {
    	throw new RuntimeException("make_LoggerTest() in agent.logging.LoggingTest should not return null.");
    }
