...
public abstract class Logging {
  ...
  public static class ComponentImpl implements Logging.Component, Logging.Parts {
    ...
    private void init_create() {
      ...
      if (this.create == null) {
      	throw new RuntimeException("make_create() in agent.logging.Logging should not return null.");
      }
    }
  ...
  public static abstract class Logger {
    ...
    public static class ComponentImpl implements Logging.Logger.Component, Logging.Logger.Parts {
      ...
      private void init_log() {
        ...
        if (this.log == null) {
        	throw new RuntimeException("make_log() in agent.logging.Logging$Logger should not return null.");
        }
      }
  ...
  public Logging.Logger _createImplementationOfLogger(final String name) {
    ...
    if (implem == null) {
    	throw new RuntimeException("make_Logger() in agent.logging.Logging should not return null.");
    }
